...
const ICONS: Record<string, string> = {
  ...
  whale: `<svg class="oi" viewBox="0 0 64 28" width="64" height="28"><g fill="none" stroke="#2e4a4a" stroke-width="1.6" stroke-linecap="round"><path d="M6 18 C14 8 34 6 46 12 C52 15 56 15 60 12 C58 18 52 20 46 19 C34 22 14 22 6 18 Z"/><path d="M20 8 C20 4 22 3 22 0 M26 8 C26 5 28 4 28 2" opacity=".8"/><circle cx="14" cy="15" r="1" fill="#2e4a4a"/></g></svg>`,
